 ...
 *
 */
public class BMJAuthentication implements Authentication {
    ...
    /**
     * Use this constructor for populating a generic Authentication (like a JWTToken)
     * @param name
     * @param password
     * @param collection
     */
    public BMJAuthentication(String name, String password, Collection<? extends GrantedAuthority> collection) {
	this.name = name;
     ...
     * anything relevant to the AuthenticationManager
     */
    @Override
